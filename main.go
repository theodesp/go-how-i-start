...
//get yourself an API key for Weather Underground.
...
func (w multiWeatherProvider) temperatureAsync(city string) (float64, error) {
...
func main() {
	// another one can be https://darksky.net/dev/
